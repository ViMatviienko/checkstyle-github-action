...
wget -O - -q --header 'Authorization: token '"$PAT" https://raw.githubusercontent.com/ViMatviienko/modified_reviewdog/dev/install.sh| sh -s -- -b /usr/local/bin/ ${REVIEWDOG_VERSION} ${INPUT_GITHUB_TOKEN}
